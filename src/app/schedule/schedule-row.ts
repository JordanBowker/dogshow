...
export const SCHEDULE_ROWS = [
    ...
    new ScheduleRow('12:25', '13:25', 'Cheekiest Puppies, Best Rescue, Waggiest Tail, Best Trick', 'classesFont'),
    new ScheduleRow('13:30', '13:50', 'Terrier Racing Demonstration'),
    new ScheduleRow('13:50', '14:35', 'Handsomest Dog, Prettiest Female, Dog The Judge Wants To Take Home', 'classesFont'),
